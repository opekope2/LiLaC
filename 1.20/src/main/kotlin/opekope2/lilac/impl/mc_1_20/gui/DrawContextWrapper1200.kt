...
class DrawContextWrapper1200(private val drawContext: DrawContext) : IDrawContext1200 {
    ...
    override fun fill(layer: RenderLayer?, x1: Int, y1: Int, x2: Int, y2: Int, color: Int) {
        drawContext.fill(layer, x1, x2, y1, y2, color)
    }

    override fun fill(layer: RenderLayer?, x1: Int, y1: Int, x2: Int, y2: Int, z: Int, color: Int) {
        drawContext.fill(layer, x1, x2, y1, y2, z, color)
    }
    ...
    override fun drawRepeatingTexture(
        ...
        drawContext.drawRepeatingTexture(texture, x, y, width, height, u, v, textureWidth, textureHeight)
    }
    ...
    @RequiresMinecraftVersion(
        ...
        maxVersion = MinecraftVersion.MINECRAFT_1_20_1
    )
    companion object Factory : (DrawContext) -> IDrawContext1200 by ::DrawContextWrapper1200
}

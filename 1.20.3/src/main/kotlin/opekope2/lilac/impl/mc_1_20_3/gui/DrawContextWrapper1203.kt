package opekope2.lilac.impl.mc_1_20_3.gui
...
import opekope2.lilac.api.gui.IDrawContext1203
import opekope2.lilac.util.MinecraftVersion
import java.util.*

class DrawContextWrapper1203(private val drawContext: DrawContext) : IDrawContext1203 {
    ...
    override fun drawItemWithoutEntity(stack: ItemStack?, x: Int, y: Int, seed: Int) {
        drawContext.drawItemWithoutEntity(stack, x, y, seed)
    }
    ...
    @RequiresMinecraftVersion(
        minVersion = MinecraftVersion.MINECRAFT_1_20_3,
    )
    companion object Factory : (DrawContext) -> IDrawContext1203 by ::DrawContextWrapper1203
}
